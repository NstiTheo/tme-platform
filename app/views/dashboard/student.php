...
<section class="dashboard-shell">
    ...
    <div class="module-grid">
        ...
        <article class="module-card"><h2>Catálogo</h2><p>Encontre cursos publicados e faca matricula com um clique.</p><a href="<?= e(url('/aluno/cursos')) ?>">Ver catalogo</a></article>
